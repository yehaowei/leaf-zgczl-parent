jQuery.fn.extend({
    ...
    initBaseLine:function(obj){
        ...
        leftLine.css({
            ...
            "width":"1px",
            "height":(jQuery("body").height()-50)+"px",
            "position":"absolute",
            "top": "0px",
            "left": obj.left+"px",
            "z-index":290
    ...
    initFloatWindow:function(opt){
        ...
        this.addNode('saveWindow','<span title="保存操作" class="float_window_button float_window_button_save"></span>').appendTo(this.floatWindow);

        this.floatEdit.click(function() {
            if(self.floatWindow.css("height") != "120px") {
                self.floatWindow.animate({height: '120px'});
                jQuery(this).css({
                ...
                self.floatWindow.animate({height: '40px'});
                jQuery(this).css({
                    "border-bottom":"none"
                });
                if(self.screenType == 'user') {
    ...
    addMouseDown : function (obj) {
        ...
        obj.mousedown(function(e){
            if(self.editModel == true) {
                ...
                if(self.screenType=='user'){
                    obj.gapY = e.clientY - jQuery(targer).offset().top - jQuery(".hap_widget_main_screen").parents().find("body").scrollTop();
                }else{
