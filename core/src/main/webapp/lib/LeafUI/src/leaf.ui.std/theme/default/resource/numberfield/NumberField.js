...
$L.NumberField = Ext.extend($L.TextField,{
    ...
    initComponent : function(config){
    	$L.NumberField.superclass.initComponent.call(this, config); 
    ...
    onKeyPress : function(e){
        ...
        $L.NumberField.superclass.onKeyPress.call(this, e); 
    },
    formatValue : function(v){
    	var rv = this.fixPrecision(this.parseValue(v))        
        if(this.allowformat)rv = $L.formatNumber(rv);
        return $L.NumberField.superclass.formatValue.call(this,rv);
    },
    ...
    onFocus : function(e) {
    	...
    	if(this.allowformat) {
            this.setRawValue($L.removeNumberFormat(this.getRawValue()));
        }
    	$L.NumberField.superclass.onFocus.call(this,e);
    },
