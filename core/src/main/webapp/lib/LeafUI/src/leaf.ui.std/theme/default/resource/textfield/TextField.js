...
$L.TextField = Ext.extend($L.Field,{
	constructor: function(config) {
        $L.TextField.superclass.constructor.call(this, config);        
    },
    initComponent : function(config){
    	$L.TextField.superclass.initComponent.call(this, config);    	
    },
    initEvents : function(){
    	$L.TextField.superclass.initEvents.call(this);   
    },
    processListener : function(ou){
    	$L.TextField.superclass.processListener.call(this, ou);
    	if(this.typecase){
    ...
    destroy : function(){
        $L.TextField.superclass.destroy.call(this);
    },
    ...
    onKeyPress : function(e){
    	$L.TextField.superclass.onKeyPress.call(this,e);
