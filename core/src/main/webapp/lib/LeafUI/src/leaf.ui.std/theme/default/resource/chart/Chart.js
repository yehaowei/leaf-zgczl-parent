...
$L.Charts = $L.Charts ? error(16, true) : {};
...
(function ($) {
	/**
	 * The default LeafAdapter for jQuery
	 */
	win.LeafAdapter = win.LeafAdapter || ($ && {
		...
		init: function (pathAnim) {
			...
			$.fn.charts = function () {
				...
				if (options !== UNDEFINED) {
					...
					chart = new $L.Charts[constr](options, args[1]);
					ret = this;
					/*jslint unused:true*/
				}
				...
				if (options === UNDEFINED) {
					ret = charts[attr(this[0], 'data-leaf-chart')];
				}	
...
// check for a custom LeafAdapter defined prior to this file
var globalAdapter = win.LeafAdapter,
...
// Utility functions. If the LeafAdapter is not defined, adapter is an empty object
...
SVGRenderer.prototype = {
	...
	/**
	 * Create a group
	 * @param {String} name The group will be given a class name of 'leaf-{name}'.
 ...
 */
$L.Charts.VMLElement = VMLElement = {
...
$L.Charts.VMLRenderer = VMLRenderer = function () {
	this.init.apply(this, arguments);
};
...
if (useCanVG) {
	 ...
	 */
	$L.Charts.CanVGRenderer = CanVGRenderer = function () {
 ...
 */
var Pointer = $L.Charts.Pointer = function (chart, options) {
...
Pointer.prototype = {
	...
	onDocumentMouseMove: function (e) {
		...
		if (chartPosition && hoverSeries && !this.inClass(e.target, 'leaf-tracker') &&
	...
	onContainerMouseMove: function (e) {
		...
		if ((this.inClass(e.target, 'leaf-tracker') ||
...
var TrackerMixin = $L.Charts.TrackerMixin = {
 ...
 */
var Legend = $L.Charts.Legend = function (chart, options) {
	this.init(chart, options);
};
...
var LegendSymbolMixin = $L.Charts.LegendSymbolMixin = {
	 ...
	 * symbols through $L.Charts.seriesTypes[type].prototype.drawLegendSymbols.
	 * 
	 * @param {Object} legend The legend object
	 */
...
Chart.prototype = {
	...
	init: function (userOptions, callback) {
		//TODO Leaf
		($L.CmpManager.cache = $L.CmpManager.cache||{})[userOptions.id]=this;
	...
	destroy: function () {
		//TODO Leaf
		delete $L.CmpManager.cache[this.options.id];
		var chart = this,
			axes = chart.axes,
			series = chart.series,
		...
		chart.renderTo.removeAttribute('data-leaf-chart');
				...
				for(var k=0,l=yAxisNames.length;k<l;k++){
		    		...
		    		for(var i=0,length = records.length;i<length;i++){
	    				...
	    				if(zAxisName){
		    				...
		    				var d2 = r.get(xAxisName);
		    				data.push([(Ext.isDate(d2)?d2:d2.parseDate(xformat||$L.defaultDateFormat)).getTime()].concat(d));
		    			}else{
...
var CenteredSeriesMixin = $L.Charts.CenteredSeriesMixin = {
	/**
