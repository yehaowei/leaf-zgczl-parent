...
HlsNoticeTable.prototype._init = function (opt) {
    ...
    this.opt = {
        ...
        titleImg: contextPath + "/leafresource/images/MAIN/hls-todo-search.png",
...
HlsRecordTable.prototype._init = function (opt) {
    ...
    this.opt = {
        ...
        titleImg: contextPath + "/leafresource/images/CONT/notice.png",
        hlsDataSource: [],
        locateEvent: null
    };
    $.extend(true, this.opt, opt || {});
        ...
        for (var i = 0; i < datas.length; i++) {
            ...
            if (datas[i][self.opt.paramMapObj['time'].map].indexOf('-') != -1) {
                innerDiv.innerHTML = projectName +
                    '<img style="height:15px;width:15px;" src="' + contextPath + '/leafresource/images/CONT/clock2.png" />&nbsp;&nbsp;&nbsp;' + datas[i][self.opt.paramMapObj['time'].map] + '&nbsp;&nbsp;&nbsp;&nbsp;<span class="notice-message">' + (datas[i][self.opt.paramMapObj['notice_message'].map] || self.opt.paramMapObj.notice_message.defaultMessage) + '</span>';
            } else {

                innerDiv.innerHTML = projectName +
                    '<img style="height:15px;width:15px;" src="' + contextPath + '/leafresource/images/CONT/clock1.png" />&nbsp;&nbsp;&nbsp;' + datas[i][self.opt.paramMapObj['time'].map] + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="notice-message">' + (datas[i][self.opt.paramMapObj['notice_message'].map] ||  self.opt.paramMapObj.notice_message.defaultMessage) + '</span>';
            }
