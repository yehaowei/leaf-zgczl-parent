 ...
 *            config 配置对象.
 */
$L.AccordionMenu = Ext.extend($L.Component, {
	constructor : function(config) {
		$L.AccordionMenu.superclass.constructor.call(this, config);
		this.context = config.context || '';
	},
	initComponent : function(config) {
		$L.AccordionMenu.superclass.initComponent.call(this, config);
		this.body = this.wrap.child('ul[atype=navigationbar.body]');
		this.navbar = [];		
	},
	processListener : function(ou) {
		//$L.NavigationBar.superclass.processListener.call(this,ou);
	...
	initEvents : function(){
		$L.AccordionMenu.superclass.initEvents.call(this);
		this.addEvents(		
		/**
         * @event click
         * 点击事件.         
