...
//      }
        if(p.length > 0) {
            ...
            $L.request({url:this.submiturl, para:p, ext:this.spara,success:this.onRemoveSuccess, error:this.onSubmitError, scope:this, failure:this.onAjaxFailed,opts:opts});
        }
...
//      this.fireBindDataSetEvent("beforeload", this);//主dataset无数据,子dataset一直loading
        ...
        this.qtId = $L.request({url:url, para:q, success:this.onLoadSuccess, error:this.onLoadError, scope:this,failure:this.onAjaxFailed,opts:opts,ext:opts?opts.ext:null});
    },
    /**
     * 判断当前数据集是否发生改变.
...
//            sf.fireEvent("submit", sf);
            $L.request({showSuccessTip:true,url:sf.submiturl, para:items, ext:sf.spara,success:sf.onSubmitSuccess, error:sf.onSubmitError, scope:sf,failure:sf.onAjaxFailed});
        //}
    },
    /**
     * 提交选中数据.
...
$L.NavBar = Ext.extend($L.ToolBar,{
	constructor: function(config) {
        $L.NavBar.superclass.constructor.call(this, config);        
    },
    initComponent : function(config){
    ...
    processListener: function(ou){
    	$L.NavBar.superclass.processListener.call(this,ou);
    ...
    initEvents : function(){
    	$L.NavBar.superclass.initEvents.call(this);    	
    },
    onLoad : function(){
...
$L.MultiLov = Ext.extend($L.Lov,{
    ...
    processListener : function(ou){
        $L.MultiLov.superclass.processListener.call(this,ou);
    ...
    initEvents : function(){
         ...
         * commit事件.
         * @param {Leaf.Lov} lov 当前Lov组件.
         * @param {Leaf.Record} r 当前lov绑定的Record
         * @param {Leaf.Record} rs 选中的Record集合. 
         */
    },
    onChange : function(e){},
    onClick : function(e){
