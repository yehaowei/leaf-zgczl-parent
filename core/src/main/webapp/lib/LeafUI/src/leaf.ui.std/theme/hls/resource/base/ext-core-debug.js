...
(function(){
    var idSeed = 0,
        ...
        isIE7 = isIE && DOC_MODE == 7,//check(/msie 7/),
        isIE8 = isIE && DOC_MODE == 8,//check(/msie 8/),
        isIE9 = isIE && DOC_MODE == 9,//check(/msie 9/),			//Add by Hugh
        isIE10 = isIE && DOC_MODE == 10,//check(/msie 10/),			//Add by Hugh
        isIE11 = DOC_MODE == 11,									//Add by Hugh
        //isIE6 = isIE && !isIE7 && !isIE8,
        isIE6 = isIE && !isIE7 && !isIE8 && !isIE9 && !isIE10,		//Modify by Hugh
        //isIE = (isIE && check(/msie 9/)) ? false : isIE,
        isIE = isIE9 || isIE10 || isIE11? false : isIE,				//Modify by Hugh
...
Ext.EventManager = function(){
    ...
    function initDocReady(){
        ...
        if (Ext.isGecko || Ext.isOpera || Ext.isIE9 || Ext.isIE10 || Ext.isIE11) {
