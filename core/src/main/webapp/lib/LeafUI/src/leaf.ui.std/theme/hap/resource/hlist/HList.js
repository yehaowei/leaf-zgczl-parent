(function ($L) {
    ...
    $L.HList = Ext.extend($L.Component, {
        constructor: function (config) {
            ...
            $L.HList.superclass.constructor.call(sf, config);
        },
        initComponent: function (config) {
            $L.HList.superclass.initComponent.call(this, config);
            sf = this;
        ...
        processListener: function (ou) {
            var sf = this;
            $L.HList.superclass.processListener.call(sf, ou);
        ...
        initEvents: function () {
            $L.HList.superclass.initEvents.call(this);
            this.addEvents(
                /**
                 ...
                 * 加载更多之前触发的事件
                 * @param {Leaf.HList} HList 当前HList组件.
                 * @param {Leaf.DataSet} dataSet 当前HList所绑定的DataSet
