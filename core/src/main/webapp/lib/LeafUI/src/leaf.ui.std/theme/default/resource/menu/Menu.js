...
A.MenuBar=Ext.extend(A.Component,{
	...
	addMenus : function(options){
		...
		EACH(options,function(opt){
			...
			children.push(opt.record.menu=new Leaf[opt.options?'Menu':'MenuItem'](Ext.apply(opt,{
				id:_id,
				parent:sf,
				bar:sf,
				index:j++
...
A.Menu=Ext.extend(A.MenuItem,{
	...
	addMenus : function(options){
		...
		EACH(options,function(item){
			...
			item.record.menu=menu=new Leaf[item.options?'Menu':'MenuItem'](Ext.apply(item,{
				id:_id,
				parent:sf,
				bar:sf.bar,
				index:j++
