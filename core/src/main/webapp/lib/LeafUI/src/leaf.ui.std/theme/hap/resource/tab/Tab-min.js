...
//      this.intervalIds=[];
        ...
        initComponent:function(config){
            ...
            // $jq("#" + sf.id).find("div.item-tab-body").niceScroll(".tab");
...
//                sf.activeBody = activeBody.setStyle({display:'block'});
            ...
            $jq("#"+sf.id).getNiceScroll().remove();
            $jq("#"+sf.id).niceScroll(".tab");
            $jq("#" + sf.id).find(".tab").niceScroll({enablemousewheel:false});
            // $jq("#"+sf.id).getNiceScroll().resize();
