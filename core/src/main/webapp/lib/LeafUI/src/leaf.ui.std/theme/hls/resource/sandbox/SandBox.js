$L.SandBox = Ext.extend($L.Component, {
	initComponent : function(config) {
		$L.SandBox.superclass.initComponent.call(this, config);	
	...
	screenTpl : "<a:screen xmlns:a='http://www.leaf-framework.org/application'><a:view template='sandbox'>{content}</a:view></a:screen>"
})
