...
$L.Field = Ext.extend($L.Component,{	
    ...
    initComponent : function(config){
    	$L.Field.superclass.initComponent.call(this, config);
    	this.initElements();
    ...
    processListener: function(ou){
    	$L.Field.superclass.processListener.call(this, ou);
...
//        this.el[ou]("mouseout", this.onMouseOut, this);
    ...
    destroy : function(){
    	$L.Field.superclass.destroy.call(this);
    	delete this.el;
    },
	setWidth: function(w){
...
//	        } 
    ...
    setValue : function(v, silent){
        ...
        this.applyEmptyText();
    	$L.Field.superclass.setValue.call(this,v, silent);
    },
    formatValue : function(v){
        var rder = null;
        if(this.renderer) rder = $L.getRenderer(this.renderer);
