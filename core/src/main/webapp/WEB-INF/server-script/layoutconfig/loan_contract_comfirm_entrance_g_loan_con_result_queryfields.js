var override_queryfields = [
		...
		},
		{
			...
			queryexpression : "${@status_check_flag}='Y' and t1.data_class='NORMAL' and nvl(t1.loan_con_wfl_status,'WFL_NEW')='WFL_APPROVED' and nvl(t1.loan_contract_status,'NEW') IN ('NEW','CHANGED') " 
		}
