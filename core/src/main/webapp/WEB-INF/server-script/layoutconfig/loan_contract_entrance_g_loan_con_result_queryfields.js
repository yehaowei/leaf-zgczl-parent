...
var override_queryfields = [
		...
		},
		{
			...
			queryexpression : "${@status_check_flag}='Y' and t1.data_class='NORMAL'  and nvl(t1.loan_con_wfl_status,'WFL_NEW') IN ('WFL_NEW','WFL_APPROVING','WFL_REJECTED','WFL_APPROVED_RETURN','CLOSED') " 
		}
		 ];
